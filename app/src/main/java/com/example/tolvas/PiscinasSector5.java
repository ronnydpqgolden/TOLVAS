            ...
            public void onClick(View view) {
                if(autoCompleteTextViewPiscinas.getText().toString().isEmpty()){
                    ...
                    if(piscinaSeleccionada.equals("Piscina 27")){
                        ...
                        p27.setT5(Integer.parseInt(Objects.requireNonNull(ETt5.getText()).toString()));
                        p27.setT6(Integer.parseInt(Objects.requireNonNull(ETt6.getText()).toString()));
                        p27.setT7(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p27.setT8(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        p27.setT9(Integer.parseInt(Objects.requireNonNull(ETt9.getText()).toString()));

                        p27.setRojo(getIntValue(ETRojo));
                        p27.setFresco(getIntValue(ETFresco));
                        p27.setReportado(getIntValue(ETReportado));
                        p27.setObservaciones(getStringValue(ETObservaciones));
                        databaseReference.child("Piscina 27").child(p27.getUid()).setValue(p27);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase9T("Piscina 27",currentDate);
                        ...
                        p28.setT6(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));

                        p28.setRojo(getIntValue(ETRojo));
                        p28.setFresco(getIntValue(ETFresco));
                        p28.setReportado(getIntValue(ETReportado));
                        p28.setObservaciones(getStringValue(ETObservaciones));
                        databaseReference.child("Piscina 28").child(p28.getUid()).setValue(p28);
                        verificarDatosEnFirebase6T("Piscina 28",currentDate);
                        Toast.makeText(PiscinasSector5.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        p29.setRojo(getIntValue(ETRojo));
                        p29.setFresco(getIntValue(ETFresco));
                        p29.setReportado(getIntValue(ETReportado));
                        p29.setObservaciones(getStringValue(ETObservaciones));
                        ...
                        p30.setRojo(getIntValue(ETRojo));
                        p30.setFresco(getIntValue(ETFresco));
                        p30.setReportado(getIntValue(ETReportado));
                        p30.setObservaciones(getStringValue(ETObservaciones));
                        ...
                        p31.setRojo(getIntValue(ETRojo));
                        p31.setFresco(getIntValue(ETFresco));
                        p31.setReportado(getIntValue(ETReportado));
                        p31.setObservaciones(getStringValue(ETObservaciones));
        ...
        autoCompleteTextViewPiscinas.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(piscinaSeleccionada.equals("Piscina 27")){
                    ...
                    verificarDatosEnFirebase9T("Piscina 27",fechaSeleccionada);
                } else if (piscinaSeleccionada.equals("Piscina 28")) {
                    limpiarCamposPiscina1();
                    TVz1.setText("ZONA 2");
                    TVz2.setText("ZONA 1");
                    ...
                    verificarDatosEnFirebase6T("Piscina 28",fechaSeleccionada);
