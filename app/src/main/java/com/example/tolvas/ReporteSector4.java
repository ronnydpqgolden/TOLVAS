                                                    ...
                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            if (formattedDate.equals(fecha)) {
                                                                ...
                                                                htmlBuilder.append("<tr><td>22</td><td>").append(rojo).append("</td><td>").append(fresco).append("</td><td>").append(reportado).append("</td><td>").append(observaciones).append("</td></tr>");
                                                            }
                                                        }
                                                            ...
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                                    ...
                                                                    if (formattedDate.equals(fecha)) {
                                                                        ...
                                                                        htmlBuilder.append("<tr><td>23</td><td>").append(rojo).append("</td><td>").append(fresco).append("</td><td>").append(reportado).append("</td><td>").append(observaciones).append("</td></tr>");
                                                                    }
                                                                }
                                                                    ...
                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                                            ...
                                                                            if (formattedDate.equals(fecha)) {
                                                                                ...
                                                                                htmlBuilder.append("<tr><td>24</td><td>").append(rojo).append("</td><td>").append(fresco).append("</td><td>").append(reportado).append("</td><td>").append(observaciones).append("</td></tr>");
                                                                            }
                                                                        }
                                                                            ...
                                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                                                    ...
                                                                                    if (formattedDate.equals(fecha)) {
                                                                                        ...
                                                                                        htmlBuilder.append("<tr><td>25</td><td>").append(rojo).append("</td><td>").append(fresco).append("</td><td>").append(reportado).append("</td><td>").append(observaciones).append("</td></tr>");
                                                                                    }
                                                                                }
                                                                                    ...
                                                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                                                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                                                            ...
                                                                                            if (formattedDate.equals(fecha)) {
                                                                                                ...
                                                                                                htmlBuilder.append("<tr><td>26</td><td>").append(rojo).append("</td><td>").append(fresco).append("</td><td>").append(reportado).append("</td><td>").append(observaciones).append("</td></tr>");
                                                                                            }
                                                                                        }
