            ...
            public void onClick(View view) {
                if(autoCompleteTextViewPiscinas.getText().toString().isEmpty()){
                    ...
                    if(piscinaSeleccionada.equals("Piscina 16")){
                        ...
                        p17.setT4(Integer.parseInt(Objects.requireNonNull(ETt4.getText()).toString()));
                        p17.setT5(Integer.parseInt(Objects.requireNonNull(ETt5.getText()).toString()));
                        databaseReference.child("Piscina 17").child(p17.getUid()).setValue(p17);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase5T("Piscina 17",currentDate);
                        Toast.makeText(PiscinasSector3.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        p20.setT5(Integer.parseInt(Objects.requireNonNull(ETt6.getText()).toString()));
                        p20.setT6(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p20.setT7(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        p20.setT8(Integer.parseInt(Objects.requireNonNull(ETt9.getText()).toString()));
                        databaseReference.child("Piscina 20").child(p20.getUid()).setValue(p20);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase8T("Piscina 20",currentDate);
                        Toast.makeText(PiscinasSector3.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        p21.setT5(Integer.parseInt(Objects.requireNonNull(ETt6.getText()).toString()));
                        p21.setT6(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p21.setT7(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        p21.setT8(Integer.parseInt(Objects.requireNonNull(ETt9.getText()).toString()));
                        databaseReference.child("Piscina 21").child(p21.getUid()).setValue(p21);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase8T("Piscina 21",currentDate);
                        Toast.makeText(PiscinasSector3.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        autoCompleteTextViewPiscinas.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(piscinaSeleccionada.equals("Piscina 16")){
                    ...
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase5T("Piscina 17",fechaSeleccionada);
