            ...
            public void onClick(View view) {
                if(autoCompleteTextViewPiscinas.getText().toString().isEmpty()){
                    ...
                    if(piscinaSeleccionada.equals("Piscina 9")){
                        ...
                        //limparcampospiscina1();
                        verificarDatosEnFirebase9T("Piscina 10A",currentDate);
                        Toast.makeText(PiscinasSector2.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        verificarDatosEnFirebase5T("Piscina 13",currentDate);
                        Toast.makeText(PiscinasSector2.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        p15.setT4(Integer.parseInt(Objects.requireNonNull(ETt6.getText()).toString()));
                        p15.setT5(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p15.setT6(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        databaseReference.child("Piscina 15").child(p15.getUid()).setValue(p15);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase6T("Piscina 15",currentDate);
                        Toast.makeText(PiscinasSector2.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        autoCompleteTextViewPiscinas.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(piscinaSeleccionada.equals("Piscina 9")){
                    ...
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase9T("Piscina 10A",fechaSeleccionada);
                    ...
                    TVt9.setEnabled(false);
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase5T("Piscina 13",fechaSeleccionada);
                } else if (piscinaSeleccionada.equals("Piscina 14")) {
                    limpiarCamposPiscina1();
                    TVz1.setText("ZONA 2");
                    TVz2.setText("ZONA 1");
                    ...
                    TVt9.setEnabled(false);
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase6T("Piscina 15",fechaSeleccionada);
                }
            }
