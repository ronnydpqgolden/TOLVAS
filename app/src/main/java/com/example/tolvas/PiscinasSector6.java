            ...
            public void onClick(View view) {
                if(autoCompleteTextViewPiscinas.getText().toString().isEmpty()){
                    ...
                    if(piscinaSeleccionada.equals("Piscina 32")){
                        ...
                        p32.setT4(Integer.parseInt(Objects.requireNonNull(ETt4.getText()).toString()));
                        databaseReference.child("Piscina 32").child(p32.getUid()).setValue(p32);
                        //limparcampospiscina1();
                        verificarDatosEnFirebase4T("Piscina 32",currentDate);
                        ...
                        p33.setT5(Integer.parseInt(Objects.requireNonNull(ETt6.getText()).toString()));
                        p33.setT6(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p33.setT7(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        p33.setT8(Integer.parseInt(Objects.requireNonNull(ETt9.getText()).toString()));
                        databaseReference.child("Piscina 33").child(p33.getUid()).setValue(p33);

                        verificarDatosEnFirebase8T("Piscina 33",currentDate);
                        Toast.makeText(PiscinasSector6.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        //limparcampospiscina1();
                        verificarDatosEnFirebase7T("Piscina 34",currentDate);
                        Toast.makeText(PiscinasSector6.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        databaseReference.child("Piscina 36A").child(p13.getUid()).setValue(p13);
                        //verificarDatosEnFirebase5T("Piscina 35B",currentDate);
                        //Toast.makeText(PiscinasSector6.this, "DATOS INGRESADOS", Toast.LENGTH_SHORT).show();
                        ...
                        p34.setT6(Integer.parseInt(Objects.requireNonNull(ETt7.getText()).toString()));
                        p34.setT7(Integer.parseInt(Objects.requireNonNull(ETt8.getText()).toString()));
                        databaseReference.child("Piscina 36B").child(p34.getUid()).setValue(p34);
                        //limparcampospiscina1();
        ...
        autoCompleteTextViewPiscinas.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(piscinaSeleccionada.equals("Piscina 32")){
                    ...
                    verificarDatosEnFirebase4T("Piscina 32",fechaSeleccionada);
                } else if (piscinaSeleccionada.equals("Piscina 33")) {
                    limpiarCamposPiscina1();
                    TVz1.setText("ZONA 1");
                    TVz2.setText("ZONA 2");
                    ...
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase8T("Piscina 33",fechaSeleccionada);
                    ...
                    TVt9.setEnabled(false);
                    botonGuardar.setEnabled(true);
                    verificarDatosEnFirebase7T("Piscina 34",fechaSeleccionada);
                } else if (piscinaSeleccionada.equals("Piscina 35A")) {
                    limpiarCamposPiscina1();
                    TVz1.setText("ZONA 1");
                    TVz2.setText("ZONA 2");
                    ...
                    TVt9.setEnabled(false);
                    botonGuardar.setEnabled(false);
                    //verificarDatosEnFirebase6T("Piscina 36A",fechaSeleccionada);
                } else if (piscinaSeleccionada.equals("Piscina 36B")) {
                    limpiarCamposPiscina1();
                    TVz1.setText("ZONA 2");
                    TVz2.setText("ZONA 1");
